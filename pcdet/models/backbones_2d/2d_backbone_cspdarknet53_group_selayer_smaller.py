...
class Resblock(nn.Module):
    def __init__(self, channels, hidden_channels=None):
        ...
        self.block = nn.Sequential(
            ...
            BasicConv(in_channels=hidden_channels, out_channels=channels, kernel_size=3,groups=hidden_channels//4),
        )
...
# CSPDarknet
class CSPDarknet53_gs_smaller(nn.Module):
    def __init__(self, model_cfg=None, input_channels=64):
        super(CSPDarknet53_gs_smaller, self).__init__()
        ...
        self.feature_channels = [32, 32, 32, 64]
        upsample_strides = [1,2,4]
        num_filters = [32,32,64]
        num_upsample_filters = [64,64,64]
        self.se1 = SELayer(self.feature_channels[1])
        self.se2 = SELayer(self.feature_channels[2])
        self.se3 = SELayer(self.feature_channels[3])
