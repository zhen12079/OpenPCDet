...
class PFNLayer(nn.Module):
    ...
    def forward(self, inputs):
        ...
        #     x = torch.cat(part_linear_out, dim=3)  # [1,64,32,21463]
        #     # x = x.squeeze(0)
        #     # x = x.T
        # else:
        # inputs = inputs.permute(2, 1, 0)
        ...
        # x = self.norm(x) if self.use_norm else x  # [1,64,32,21463]
        # x = x.squeeze(0)
        # x = x.permute(2, 1, 0)
...
class PillarVFE_TA_va_lane(VFETemplate):
    def __init__(self, model_cfg, num_point_features, voxel_size, point_cloud_range, **kwargs):
        ...
        num_point_features += 3 if self.use_absolute_xyz else 3
    ...
    def forward(self, batch_dict, **kwargs):
        voxel_features, voxel_num_points, coords = batch_dict['voxels_lane'], batch_dict['voxel_num_points_lane'], batch_dict[
            'voxel_coords_lane']
        ...
        batch_dict['pillar_features_lane'] = features
        # print(features.shape)
        return batch_dict
