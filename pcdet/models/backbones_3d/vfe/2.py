...
class DynamicPillarVFE(VFETemplate):
    ...
    def forward(self, batch_dict, **kwargs):
        ...
        points_coords = torch.floor((torch.clip(points[:, [1,2]], self.point_cloud_range[[0,1]], self.point_cloud_range[[3,4]]) - self.point_cloud_range[[0,1]]) / self.voxel_size[[0,1]]).int()
